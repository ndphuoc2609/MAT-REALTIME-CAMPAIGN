...
export function validateDisplayName(value, links = [], currentId = null) {
  ...
  if (links.some(link => link.id !== currentId && normalizedName(link.name) === key)) throw Error('Tên hiển thị đã tồn tại.');
  return name;
}
