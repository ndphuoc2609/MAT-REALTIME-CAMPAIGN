...
function identifyMetaReport(url) {
...
export function identify(input) {
  ...
  if (u.hostname === 'facebook.com' || u.hostname === 'www.facebook.com' || u.hostname === 'adsmanager.facebook.com') {
    ...
    connector = 'meta-ads';
    metaReport = identifyMetaReport(u);
    from = metaReport.from; to = metaReport.to; campaign = metaReport.filters.campaignName;
